...
<body>
	...
	<div id="list_div">
	    ...
	    <form action="queryIt" method="post">
			<big>商品名称：</big><input style="border:#aaa 1.5px solid;" type="text" name="nameContain" placeholder="请输入商品名称" /> 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<big>价格范围：</big><input style="width:65px; border:#aaa 1.5px solid;" type="number" name="priceMin" /> 
			--
			<input style="width:65px; border:#aaa 1.5px solid;" type="number" name="priceMax" /> 
			...
			<tfoot>
		        ...
		        <tr>
		       		<td colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共${page.totalRecords}条记录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                ...
		                <a href="goodsManage?pageNo=${page.topPageNo}">
		                <input type="button" name="fristPage" value="首页" /></a>
		                <c:choose>
		                  <c:when test="${page.pageNo!=1}">             
		                      <a href="goodsManage?pageNo=${page.previousPageNo }">
				    ...
				    <%--总页数没有6页--%>  
					    ...
					    <c:forEach var="i" begin="${begin}" end="${end}">  
					        ...
					        <c:choose>  
					            ...
					            <%--不是当前页--%>  
					            <c:otherwise>  
					                <li><a href="goodsManage?pageNo=${i}">${i}</a></li>  
					            </c:otherwise>  
					        </c:choose>  
					    </c:forEach> 
					    </ul> 
		                <c:choose>
		                  <c:when test="${page.pageNo != page.totalPages}">
		                    <a href="goodsManage?pageNo=${page.nextPageNo }">
		                ...
		                <a href="goodsManage?pageNo=${page.bottomPageNo}">
